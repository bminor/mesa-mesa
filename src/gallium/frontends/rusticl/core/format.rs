...
// broken
//  (CL_RGB,       CL_UNORM_SHORT_565)        => pipe_format::PIPE_FORMAT_B5G6R5_UNORM,
    ...
    (CL_ABGR,      CL_UNORM_INT_2_101010_EXT) => pipe_format::PIPE_FORMAT_R10G10B10A2_UNORM,
...
impl CLFormatInfo for cl_image_format {
    ...
    fn format_info(&self) -> Option<(u8, bool)> {
        match self.image_channel_data_type {
            ...
            CL_UNORM_INT_101010 | CL_UNORM_INT_101010_2 | CL_UNORM_INT_2_101010_EXT => {
                Some((4, true))
            }
            _ => None,
        }
